...
export default function form({ product, send, open, handleClose }) {
  ...
  const handleSubmit = useCallback(
    async (data) => {
      try {
        ...
        showLoading();
        await send(product.id || null, data);
        hideLoading();
        handleClose();
      } catch (err) {
        hideLoading();
    ...
    [hideLoading, showLoading, send, product, handleClose]
  );
...
form.propTypes = {
  product: PropTypes.shape(), //eslint-disable-line
